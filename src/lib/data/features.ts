...
export default [ 
  {
    ...
    tags: [{ label: 'Giáo viên trong và ngoài nước' }]
  }, 
  {
    ...
    tags: [{ label: 'Dong Hai' }, { label: 'Secondary Color', color: 'HCMC' }]
  }, 
  {
    name: 'Y học Thay thế',
    description:
  ...
  }, 
  {
    ...
    tags: [{ label: 'Thực phẩm làm thuốc' }]
  }, 
  {
    name: 'Đơn vị Chủ đạo Ananda Marga',
    description:
